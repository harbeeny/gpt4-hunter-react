  ...
  return (
    <div className='gpt4__header section__padding' id='home'>
      <div className='gpt4__header-content'>
        ...
        <p>Yet bed any for traveling assistance indulgence unpleasing. Not thoughts all exercise blessing. Indulgence way everthing joy alteration boisterous the attachment. Party we years to order allow asked of.</p>
